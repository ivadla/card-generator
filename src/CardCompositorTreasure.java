		...
		if (document.getElementById("cardValue") != null) {
			...
			if (card.getCoinValue() == null) {
				new TextCompositor(this, getTemplate()).increaseHeightOfTextElement(document.getElementById("cardText"),
						Double.parseDouble(document.getElementById("valueBackground").getAttribute("y")) * 1.2);
				document.getElementById("cardValue").getParentNode().removeChild(document.getElementById("cardValue"));
				document.getElementById("valueBackground").getParentNode().removeChild(document.getElementById("valueBackground"));

			} else {
				document.getElementById("cardValue").getFirstChild().setTextContent(new Integer(card.getCoinValue()).toString());
			}
		}
